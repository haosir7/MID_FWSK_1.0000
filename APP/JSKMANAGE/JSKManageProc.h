...
public:
	...
	*/
	static INT32 SKPXXCX_Proc(CUserInfo *pUserInfo, string &strCurTime, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 BSPXXCX_Proc(CUserInfo *pUserInfo, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 JKSJCX_Proc(CInvKind *pInvKind, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 SQSLCX_Proc(CTax *pTax, UINT8 &taxNum, string &strErr);
	...
	*/
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 NetPara_Proc(CNetPara *pNetPara, string &strErr);

...
public:
	...
	*/
	...
	@return 
	*/
	static void InvDetail2Data(CInvHead *pInvHead,UINT8 *pDataPtr,UINT32 &nDataLen);

	/*!
	@brief 金税盘中发票明细数据转换发票数据
	@param[in] UINT8 *pDataPtr
	@param[out]  CInvHead *pInvHead
	@return 
	*/
	static void Data2InvDetail(INT8 *pDataPtr,CInvHead *pInvHead, UINT8 flag=0);
	...
	@param[out]CTax *pTax 税率
	@param[out] string &strErr 错误信息
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
    static INT32 GetCorpInfo(CUserInfo *pUserInfo,CTax *pTax,string &strErr);
	...
	*/
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
    static INT32 GetFirstOffInvInfo(CInvHead *pInvHead,string &strErr);
	...
	*/
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
    static INT32 GetOffLimitInfo(CInvKind *invKind,UINT32 &invNum, string &strErr);
    static INT32 GetOffLimitInfo(UINT8 fplx, CInvKind *invKind,string &strErr);
	...
	*/
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
    static INT32 App2NetInvVol(UINT8 Type,UINT16 &outLen,UINT8 *NetCrypData,CInvVol *invVol,string &strErr);
	...
	*/
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
    static INT32 GetJSKInvVolInfo(CInvVol *invVol,UINT32 &nInvNum,string &strErr);
	
/*!
	@brief 开票(正票,红票,空白作废)
	@param[in] 开票信息 CInvHead *pInvHead
	@param[out] string &strErr 错误信息
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 MakeInvHandInfo(CInvHead *pInvHead , string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 WasteInvHandInfo(CInvHead *pInvHead ,string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 GetCurInvInfo(CInvVol *pInvVol,string &strErr);
	...
	*/
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 HostToInvBSP(CInvVol *pInvVol, string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 HostToInvJSP(CInvVol *pInvVol, string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 InvVolRetBSP(CInvVol *pInvVol,string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 InvVolRetJSP(CInvVol *pInvVol,string &strErr);
	...
	*/
	...
	/*!
	@brief 发票查询
	@param[in] CInvHead *pInvHead  INBUFF[24]  unsigned int发票起始号;16B发票代码; unsigned int发票索引号（可选，若上层数据库无此字段，填充4字节0xFF）
	@param[out]  CInvHead *pInvHead  查询的发票信息
	@param[out] string &strErr 错误信息
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 GetInvDetailInfoNO(CInvHead *pInvHead,string &strErr);
	static INT32 GetInvDetailInfoNO(CInvHead *pInvHead, UINT8 *invBuff, UINT32 &invLen, string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 GetInvDetailInfoDate(UINT8 *chDate,CInvHead *pInvHead,UINT8 &uInvFlag,string &strErr);
	...
	@return 如果不成功，返回错误号及错误描述；成功，返回JSK_SUCCESS
	*/
	static INT32 GetMonthCountDate(UINT32 iDate,UINT8 FpType,CTjxxhz *pTjxxhz,string &strErr);

...
public:
	...
	*/
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 BSPFPCX_Proc(string fplxdm, UINT32 &invNum, CInvVol *pInvVol, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 BSPFPFF_Proc(UINT8 jzlx, CInvVol *pInvVol, string &strErr);
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 BSPFPSH_Proc(UINT8 jzlx, CInvVol *pInvVol, string &strErr);
	...
	*/
	...
	@return  1 SUCCESS； 0  FAILURE
	*/
	static INT32 TJXXCX_Proc(string strFplxdm, INT32 &MonthCount, CTjxxhz *pTjxxhz, string &strErr);
